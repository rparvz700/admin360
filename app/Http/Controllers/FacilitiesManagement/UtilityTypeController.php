                ...
                ->addColumn('actions', function ($row) {
                    return '
                        <div class="btn-group">
                            ...
                            <form action="' . route('utility-types.destroy', $row->id) . '" method="POST" style="display:inline-on-block;" onsubmit="return confirm(\'Are you sure you want to delete this utility type?\')">
                                ' . csrf_field() . '
                                ' . method_field('DELETE') . '
