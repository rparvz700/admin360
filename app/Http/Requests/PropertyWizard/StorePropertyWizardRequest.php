...
class StorePropertyWizardRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'expiry_date' => 'nullable|date|after_or_equal:payment_start_date',
    ...
    public function messages(): array
    {
        return [
            ...
            'to_date.after_or_equal' => 'Expiry Date must be the same as or after Payment Start Date.',
            'expiry_date.after_or_equal' => 'Expiry Date must be the same as or after Payment Start Date.',
