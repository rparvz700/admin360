    ...
    <div class="content">
        <div class="block block-rounded">
            ...
            <div class="block-header block-header-default">
                <h3 class="block-title">Vehicle Documents</h3>
                <a href="{{ route('vehicle-documents.create') }}" class="btn btn-sm btn-primary">Add Vehicle Document</a>
            </div>
            ...
            class e {
                static initDataTables() {
                    ...
                    jQuery(".js-dataTable-responsive").DataTable({
                        ajax: '{{ route('vehicle-documents.list') }}',
                        processing: true,
                        serverSide: true,
