...
<div class="content">
    <div class="block block-rounded">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">Vehicle Types</h3>
            <a href="{{ route('vehicle-types.create') }}" class="btn btn-primary btn-sm float-end">Add Vehicle Type</a>
        </div>
        ...
        !(function() {
            class e {
                static initDataTables() {
                    ...
                    jQuery("#vehicle-types-table").DataTable({
