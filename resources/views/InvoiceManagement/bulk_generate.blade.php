...
<div class="content">
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <a href="{{ route('invoices.index') }}" class="btn btn-secondary btn-sm float-end">
...
@section('scripts')
    ...
    (function() {
        ...
        $('#btn-load-agreements').on('click', function() {
            ...
            $.ajax({
                url: '{{ route("invoices.bulk-generate.preview") }}',
                type: 'POST',
                data: {
        ...
        $(document).on('click', '.btn-rent-details', function(e) {
            ...
            $.get('{{ url("invoices/rent-breakdown-modal") }}/' + rentId)
                .done(function(html) {
        ...
        function submitBulkGenerate(payloadRows) {
            ...
            $.ajax({
                url: '{{ route("invoices.bulk-generate.store") }}',
                type: 'POST',
                data: {
                    billing_month: currentBillingMonth,
