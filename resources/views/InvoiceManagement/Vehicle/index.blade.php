...
@section('title') Vehicle Maintenance Invoices @endsection
...
<div class="content">
    <div class="block block-rounded">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title"><i class="fa fa-car me-2 text-primary"></i> Vehicle Maintenance Invoices</h3>
        </div>
        ...
        <div class="block-content fs-sm data-content">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-vcenter table-hover js-dataTable-full js-dataTable-responsive w-100" id="vehicle-invoices-table">
                    <thead>
                        <tr>
                            <th class="text-nowrap">Invoice #</th>
                            <th class="text-nowrap">Vehicle / Maintenance Item</th>
                            <th class="text-nowrap">Vendor / Garage</th>
...
@section('scripts')
    ...
    <script>
        $(function() {
            var table = $('#vehicle-invoices-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('invoices.vehicle.index') }}",
                    data: function(d) {
            ...
            $('#filter_payment_status').on('change input', function() {
                table.draw();
            });
            ...
            $(document).on('click', '.btn-record-payment', function(e) {
                ...
                $('#form-record-payment').attr('action', '{{ url("invoices/vehicle") }}/' + id + '/pay');
