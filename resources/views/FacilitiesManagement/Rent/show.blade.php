                ...
                <section class="mb-4 p-3 border rounded bg-light">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-4">
                            <label class="form-label">Agreement Reff No.</label>
                            <div class="form-control-plaintext">{{ $base->agreement->agreement_ref_no ?? '' }}</div>
                        </div>
                        <div class="col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="col-md-6 col-sm-12 mb-4">
                            ...
                            <div class="form-control-plaintext">{{ $base->agreement->from_date ?? '' }}</div>
                        </div>
                        <div class="col-md-6 col-sm-12 mb-4">
                            <label class="form-label">End Date</label>
                            <div class="form-control-plaintext">{{ $base->agreement->to_date ?? '' }}</div>
                        </div>
