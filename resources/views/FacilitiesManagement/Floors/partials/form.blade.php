...
<div class="floor-form-section">
    ...
    <div class="row g-4">
        <div class="col-lg-6">
            ...
            <select class="form-select js-select2 @error('building_id') is-invalid @enderror" id="building_id" name="building_id"
                required>
        ...
        <div class="col-lg-4">
            ...
            <select class="form-select js-select2 @error('project_id') is-invalid @enderror" id="project" name="project_id">
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            ...
            <input type="number" step="0.01" class="form-control @error('floor_area_sft') is-invalid @enderror"
                id="floor_area_sft" name="floor_area_sft" value="{{ old('floor_area_sft', $floor->floor_area_sft ?? '') }}">
        ...
        <div class="col-lg-4">
            ...
            <input type="number" step="0.01" class="form-control @error('store_space_sft') is-invalid @enderror"
                id="store_space_sft" name="store_space_sft" value="{{ old('store_space_sft', $floor->store_space_sft ?? '') }}">
        ...
        <div class="col-lg-6">
            ...
            <select class="form-select js-select2 @error('premises_type') is-invalid @enderror" id="premises_type" name="premises_type">
                <option value="">Select Premises Type</option>
                <option value="Office Room" {{ $premisesTypeValue === 'Office Room' ? 'selected' : '' }}>Office Room</option>
                ...
                <option value="Store Room" {{ $premisesTypeValue === 'Store Room' ? 'selected' : '' }}>Store Room</option>
                <option value="Power Room" {{ $premisesTypeValue === 'Power Room' ? 'selected' : '' }}>Power Room</option>
                <option value="Client Room" {{ $premisesTypeValue === 'Client Room' ? 'selected' : '' }}>Client Room</option>
            </select>
            @error('premises_type')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
