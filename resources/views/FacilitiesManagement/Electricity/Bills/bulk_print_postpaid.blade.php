...
<body>
        ...
        <table class="header-table">
            <tr>
                <td class="logo-section">
                    <img src="{{ asset('media/photos/scomm_logo.png') }}" alt="Summit Logo" style="height: 50px; width: auto; object-fit: contain;">
                </td>
    ...
    <table class="bill-table">
        ...
        <thead>
            <tr>
                <th rowspan="2">S/L</th>
                <th rowspan="2">Office/POP Code & Name</th>
                <th rowspan="2">Maintain From</th>
                <th rowspan="2">Land owner Name</th>
                <th rowspan="2">Line Owner Name</th>
                <th rowspan="2">Month Name</th>
                <th colspan="2">Consumed (kWh)</th>
                <th rowspan="2">Total Elec. Bill</th>
                <th rowspan="2">service charge</th>
                <th rowspan="2">Vat</th>
                <th rowspan="2">Total Bill Amount</th>
                <th rowspan="2">Bill Received Date</th>
                <th rowspan="2">Last Payment Date</th>
                <th rowspan="2">Last M. Bill</th>
