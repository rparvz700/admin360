...
@section('title') Electricity Requisitions & Bills @endsection
...
<div class="content">
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title"><i class="fa fa-file-invoice-dollar text-primary me-2"></i> Electricity Requisitions & Bills</h3>
            <div class="block-options">
                <a href="{{ route('electricity.bills.create') }}" class="btn btn-sm btn-primary">
                    <i class="fa fa-plus me-1"></i> New Bill / Recharge Requisition
                </a>
            </div>
        </div>
        <div class="block-content block-content-full">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-vcenter table-hover js-dataTable-full js-dataTable-responsive w-100" id="bills-table">
                    <thead>
                        <tr>
                            <th class="text-nowrap">Requisition Ref No</th>
        ...
        $(document).ready(function() {
            ...
            var table = $('#bills-table').DataTable({
                ...
                language: {
                    ...
                    emptyTable: '<div class="text-center py-4 text-muted"><i class="fa fa-file-invoice-dollar fa-2x mb-2 d-block opacity-50"></i>No requisitions or bills generated yet</div>'
                },
                ajax: {
                ...
                columns: [
                    ...
                    { data: 'total_amount_formatted', name: 'total_amount', className: 'fw-bold text-primary text-end' },
            ...
            $(document).on('click', '.mark-paid-btn', function() {
                ...
                $('#mark-paid-form').attr('action', '/facilities-management/electricity/bills/' + billId + '/pay');
