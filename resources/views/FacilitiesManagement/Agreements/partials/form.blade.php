...
<div class="agreement-form-section">
    ...
    <div class="row g-4">
        <div class="col-lg-6">
            ...
            <input type="text" class="form-control form-control-lg @error('agreement_ref_no') is-invalid @enderror"
                id="agreement_ref_no" name="agreement_ref_no"
        ...
        <div class="col-12">
            ...
            <textarea class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" rows="4"
